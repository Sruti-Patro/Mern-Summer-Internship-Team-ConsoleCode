...
function Home() {
  return (
    <div className="max-w-md mx-auto bg-grey rounded-xl shadow-md overflow-hidden md:max-w-6xl " style={{color:"white"}}>
      <div>
        <Image
          isBlurred
          style={{
          ...
          classNames="m-5"
        />
        <h4 className="text-white font-bold text-large m-20 text-centre">
        ...
        <div className="space-y-16 pl-96">
          <div className="  flex gap-4 items-center m-20 text-centre ">
            <Button size="lg ">EXPLORE CULTPASS</Button>
          </div>
        </div>
          ...
          <div className="max-w-[900px] gap-0  grid-rows-2 px-20">
            <Card className="col-span-12 sm:col-span-4 h-[200px]">
              <CardHeader className="absolute z-10 top-1 flex-col !items-start">
                ...
                <small className=" text-white text-default-500">
                  unlimited access to all group classses,all gyms and at-home
                  workouts
                </small>
              </CardHeader>
              <Image
            ...
            <div className="max-w-[900px] gap-2 grid grid-cols-11 grid-rows-2 px-8">
              ...
              <Card className="col-span-12 sm:col-span-4 h-[300px]">
                <CardHeader className="absolute z-10 top-1 flex-col !items-start">
                  ...
                  <h4 className="text-white font-medium text-large ">
                    Make health easy,one day at a time
                  </h4>
                </CardHeader>
                <Image
                  removeWrapper
